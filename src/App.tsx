...
const RECENT_INVESTMENTS = [
  { name: 'Marcos T.', city: 'SP', amount: 'R$ 85.000', biz: 'App de saude' },
  { name: 'Juliana R.', city: 'RJ', amount: 'R$ 120.000', biz: 'E-commerce' },
  { name: 'Andre L.', city: 'MG', amount: 'R$ 50.000', biz: 'Restaurante' },
  { name: 'Bianca S.', city: 'PR', amount: 'R$ 200.000', biz: 'FinTech' },
  { name: 'Thiago M.', city: 'SC', amount: 'R$ 75.000', biz: 'Agencia' },
  { name: 'Carla F.', city: 'BA', amount: 'R$ 100.000', biz: 'Clinica' },
  { name: 'Diego P.', city: 'RS', amount: 'R$ 60.000', biz: 'Loja online' },
  { name: 'Patricia V.', city: 'PE', amount: 'R$ 150.000', biz: 'EdTech' },
];
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-red-600 via-red-500 to-red-600 text-white py-2.5 px-4">
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold">
        ...
        <span className="hidden sm:inline">de 200 — Inscricao encerra em breve</span>
      </div>
    </div>
  );
}
    ...
    <nav className={`fixed top-10 sm:top-9 left-0 right-0 z-40 transition-all duration-500 ${scrolled ? 'bg-slate-900/95 backdrop-blur-md shadow-2xl py-3' : 'py-4 sm:py-5'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-8 text-sm text-slate-300">
          ...
          <a href="#historia" className="hover:text-teal-400 transition-colors">Nossa Historia</a>
    ...
    <section className="bg-dark-gradient relative min-h-screen flex items-center pt-28 sm:pt-32 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center">
        <div className="inline-flex items-center gap-2 bg-teal-500/10 border border-teal-500/20 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 mb-6 sm:mb-8">
          ...
          <span className="text-teal-300 text-xs sm:text-sm font-medium">Conexao direta com investidores do Shark Tank USA</span>
        </div>

        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-[1.08] mb-5 sm:mb-6">
          <span className="text-gradient-hero">Receba Ate</span>
          <br />
          <span className="text-gradient-gold">R$ 100.000</span>
          <br />
          <span className="text-gradient-hero">Para Criar Seu Negocio</span>
        </h1>

        <p className="text-slate-300 text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2">
          Voce assiste o Shark Tank e pensa <span className="text-amber-400 font-bold">"eu queria ter essa chance"</span>?
          Agora voce tem. Centenas de investidores estao procurando brasileiros como voce pra financiar com ate R$100.000.
          <span className="text-white font-semibold"> Sem experiencia previa. Sem burocracia. So a sua ideia e a vontade.</span>
        </p>
        ...
        <div className="grid grid-cols-3 gap-4 sm:gap-6 max-w-lg sm:max-w-2xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="text-slate-400 text-xs sm:text-sm mt-1">Ja Investidos</div>
          </div>
          <div className="text-center">
            <div className="text-2xl sm:text-3xl md:text-4xl font-black text-teal-400"><AnimatedCounter end={312} suffix="+" /></div>
            <div className="text-slate-400 text-xs sm:text-sm mt-1">Negocios Financiados</div>
          </div>
        </div>
...
function Ticker() {
  const investments = [
    'R$ 80.000 — Cafe Especial — SP', 'R$ 100.000 — App de Delivery — RJ',
    'R$ 45.000 — E-commerce Sustentavel — MG', 'R$ 150.000 — HealthTech — PR',
    'R$ 60.000 — Clinica Veterinaria — BA', 'R$ 200.000 — EdTech — SC',
    'R$ 35.000 — Loja de Roupas — PE', 'R$ 120.000 — SaaS B2B — RS',
    'R$ 75.000 — Restaurante — GO', 'R$ 90.000 — Agencia Digital — CE',
  ...
  return (
    <section ref={ref} className="bg-section-dark py-14 sm:py-16">
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <p className="text-center text-slate-400 text-xs sm:text-sm font-medium uppercase tracking-widest mb-6 sm:mb-8">Gente como voce que ja recebeu</p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          {[
            { name: 'Lucas M.', city: 'Sao Paulo', amount: 'R$ 80.000', biz: 'App de delivery', verb: 'conseguiu' },
            { name: 'Camila R.', city: 'Rio de Janeiro', amount: 'R$ 100.000', biz: 'Cafe especial', verb: 'recebeu' },
            ...
            { name: 'Pedro H.', city: 'Salvador', amount: 'R$ 60.000', biz: 'Clinica vet.', verb: 'abriu com' },
            { name: 'Juliana F.', city: 'Florianopolis', amount: 'R$ 200.000', biz: 'EdTech', verb: 'escalou com' },
            { name: 'Carlos E.', city: 'Recife', amount: 'R$ 35.000', biz: 'Moda sustentavel', verb: 'lancou com' },
...
function Story() {
  const { ref, isVisible } = useInView();
  return (
    <section id="historia" ref={ref} className="bg-dark-gradient py-16 sm:py-20 relative overflow-hidden">
      ...
      <div className={`max-w-4xl mx-auto px-4 sm:px-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-8 sm:mb-12">
          <span className="inline-block bg-amber-500/10 text-amber-400 text-xs sm:text-sm font-semibold px-3 sm:px-4 py-1.5 rounded-full mb-4">A Historia Por Tras</span>
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-4 leading-tight">
            Por Que Investidores Estao <span className="text-gradient-gold">Despejando Milhoes</span> em Brasileiros Comuns?
          </h2>
        </div>

        <div className="space-y-5 sm:space-y-6 text-slate-300 leading-relaxed text-base sm:text-lg">
          <p>
            Voce sabe aquela sensacao quando assiste o Shark Tank e pensa: <span className="text-amber-400 font-semibold">"Caramba, eu teria uma ideia melhor que essa"</span>?
            Pois e. Agora imagine o seguinte: os investidores tambem pensam assim. Eles sabem que o Brasil ta cheio de gente como voce.
          </p>
          <div className="glass rounded-2xl p-5 sm:p-6 border-l-4 border-teal-400 my-6 sm:my-8">
            <p className="text-white font-semibold text-lg sm:text-xl">
              "O Brasil nao tem falta de talento. Tem falta de acesso. Gente brilhante morrendo de vontade de empreender e ninguem pra olhar e dizer: eu acredito nisso — toma o dinheiro."
            </p>
          </div>
          <p>
            ...
            Eles viram um dado absurdo: <span className="text-teal-400 font-semibold">97% dos brasileiros que querem empreender nunca conseguem financimento.</span>
            Nao e que falta ideia. Falta conexao.
          </p>
          <p>
            Foi ai que nasceu a <span className="text-white font-bold">InvestConnect BR</span> —
            a plataforma que coloca voce, brasileiro com uma ideia, diretamente na frente de centenas de investidores que <span className="text-amber-400 font-bold">estao pedindo pra encontrar o proximo grande negocio.</span>
          </p>
          <p>
            Hoje sao <span className="text-amber-400 font-bold">847+ investidores</span> cadastrados.
            E aqui vem o que mais surpreende: <span className="text-white font-semibold">eles estao preferindo ideias simples.</span>
            Por que? Porque negocio simples da certo mais rapido. Um cafe, uma loja online, uma clinica — coisas que voce ja pensou em abrir.
            <span className="text-teal-400 font-semibold"> Voce nao precisa inventar o Uber. Voce precisa de vontade e de alguem que acredite em voce.</span>
          </p>
          <div className="glass rounded-2xl p-5 sm:p-6 border-l-4 border-amber-400">
            <p className="text-slate-300 text-sm sm:text-base">
              <span className="text-amber-400 font-bold">Pense nisso:</span> quantas vezes voce teve uma ideia e nao fez nada porque nao tinha dinheiro?
              E se tivesse tido alguem disposto a colocar R$100.000 na sua mao? Sua vida seria diferente hoje.
              <span className="text-white font-semibold"> Essa pessoa existe. Ela ta na plataforma esperando por voce.</span>
            </p>
          </div>
        </div>
      </div>
...
function HowItWorks() {
  const { ref, isVisible } = useInView();
  const steps = [
    { icon: <Users className="w-6 h-6 sm:w-7 sm:h-7" />, num: '01', title: 'Acesse a Plataforma', desc: 'Em minutos voce ja esta dentro. Centenas de investidores-anjo, fundos e olheiros do Shark Tank estao la TODOS os dias buscando projetos como o seu. Eles vem ate voce.' },
    { icon: <Target className="w-6 h-6 sm:w-7 sm:h-7" />, num: '02', title: 'Apresente Seu Projeto', desc: 'Nao precisa ser perfeito. Um cafe, um app, uma loja — descreva sua ideia. Investidores buscam potencial e vontade, nao pitch profissional. A plataforma te guia passo a passo.' },
    { icon: <Handshake className="w-6 h-6 sm:w-7 sm:h-7" />, num: '03', title: 'Receba Lances de Investimento', desc: 'Investidores veem seu projeto e fazem lances. Voce pode receber multiplos lances e escolher o melhor. Ate R$100.000 ou mais. Voce decide.' },
    { icon: <Rocket className="w-6 h-6 sm:w-7 sm:h-7" />, num: '04', title: 'Lance Seu Negocio', desc: 'Com o capital recebido, voce transforma sua ideia em realidade. E o investidor continua do seu lado — com mentoria e suporte pra voce crescer.' },
  ];
  return (
    <section id="como-funciona" ref={ref} className="bg-section-dark py-16 sm:py-20 relative">
      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-10 sm:mb-16">
          <span className="inline-block bg-teal-500/10 text-teal-400 text-xs sm:text-sm font-semibold px-3 sm:px-4 py-1.5 rounded-full mb-4">Simples e Rapido</span>
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-3 sm:mb-4">
            Como Voce Vai Receber <span className="text-gradient-gold">Ate R$100.000</span>
          </h2>
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto px-2">4 passos entre voce e o investimento que pode mudar tudo</p>
        </div>
...
function InvestorTypes() {
  const { ref, isVisible } = useInView();
  const types = [
    { icon: <BadgeDollarSign className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Investidores-Anjo', desc: 'Empresarios de sucesso que investem capital proprio em quem ta comecando. Eles ja construíram negocios — agora querem construir o seu junto.', count: '420+' },
    { icon: <Building2 className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Fundos de Investimento', desc: 'Fundos com capital de milhoes especificamente alocado para novos negocios brasileiros. Eles PRECISAM investir — e estao buscando ativamente.', count: '85+' },
    ...
    { icon: <Globe className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Investidores Internacionais', desc: 'Investidores globais que veem no Brasil o proximo grande mercado. Trazem capital forte e experiencia que voce nao encontra em lugar nenhum.', count: '312+' },
  ];
  return (
    <section id="investidores" ref={ref} className="bg-dark-gradient py-16 sm:py-20 relative overflow-hidden">
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-10 sm:mb-16">
          <span className="inline-block bg-amber-500/10 text-amber-400 text-xs sm:text-sm font-semibold px-3 sm:px-4 py-1.5 rounded-full mb-4">Quem Vai Investir em Voce</span>
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-3 sm:mb-4">
            Centenas de Investidores <span className="text-teal-400">Prontos Para Investir</span>
          </h2>
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto px-2">Eles estao na plataforma AGORA. Buscando ativamente o proximo projeto. <span className="text-amber-400 font-semibold">O proximo pode ser o seu.</span></p>
        </div>
...
function Testimonials() {
  const { ref, isVisible } = useInView();
  const testimonials = [
    { name: 'Lucas Mendes', city: 'Sao Paulo, SP', text: 'Eu via o Shark Tank toda semana e pensava "eu queria essa chance". Quando entrei na plataforma, em 3 semanas recebi R$80.000 de um investidor-anjo. Meu app de delivery hoje atende 15 cidades. A chance que eu esperava finalmente apareceu.', amount: 'R$ 80.000', biz: 'App de Delivery' },
    { name: 'Camila Rodrigues', city: 'Rio de Janeiro, RJ', text: 'Eu jurava que era bom demais pra ser verdade. Mas entrei, apresentei meu projeto de cafe especial e recebi R$100.000. O investidor ate me ajuda com mentorias hoje. Minha unica arrependimento? Nao ter entrado antes.', amount: 'R$ 100.000', biz: 'Cafe Especial' },
    { name: 'Rafael Souza', city: 'Belo Horizonte, MG', text: 'Minha ideia era simples: e-commerce de produtos sustentaveis. Nao achava que investidor ia se interessar por algo tao simples. Recebi 3 lances em 2 semanas. Escolhi o melhor: R$45.000. Ideia simples tambem vale dinheiro.', amount: 'R$ 45.000', biz: 'E-commerce' },
    { name: 'Ana Paula Ferreira', city: 'Curitiba, PR', text: 'Sou medica e queria criar uma healthtech mas nao tinha R$1 pra investir. Na plataforma, um fundo de investimento me ofereceu R$150.000. Mudou completamente a trajetoria da minha vida profissional.', amount: 'R$ 150.000', biz: 'HealthTech' },
    { name: 'Pedro Henrique Lima', city: 'Salvador, BA', text: 'Eu queria abrir uma clinica veterinaria. Coloquei o projeto e em 10 dias ja tinha proposta. R$60.000 que transformaram meu sonho de anos em realidade. Se voce tem uma ideia, entra. Nao pensa duas vezes.', amount: 'R$ 60.000', biz: 'Clinica Veterinaria' },
    ...
    <section id="depoimentos" ref={ref} className="bg-section-dark py-16 sm:py-20 relative">
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-3 sm:mb-4">
            Gente Como Voce Que Ja <span className="text-gradient-gold">Recebeu Investimento</span>
          </h2>
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto px-2">Sem experiencia. Sem contato. Sem sorte. So a ideia e a vontade. <span className="text-amber-400 font-semibold">Eles entraram e conseguiram. Voce tambem pode.</span></p>
        </div>
...
function WhyNow() {
  const { ref, isVisible } = useInView();
  const reasons = [
    { icon: <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Janela de Oportunidade', desc: 'O ecossistema de investimentos brasileiro esta em expansao historica. Os investidores estao entrando em massa agora. Quem chega primeiro tem vantagem. Quem demora, perde.' },
    { icon: <Zap className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Mais Investidores Que Projetos', desc: 'Hoje existem 3x mais investidores buscando projetos do que empreendedores na plataforma. Isso significa que as chances de voce receber lances sao altas. Mas essa proporcao vai mudar.' },
    { icon: <Shield className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Processo Seguro e Transparente', desc: 'Contratos formais, due diligence, acompanhamento juridico. Todo o processo e conduzido com seguranca total. Nada de informal — tudo documentado e profissional.' },
    { icon: <Award className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Mentoria Inclusa', desc: 'O investidor nao so coloca dinheiro — ele coloca experiencia. Voce recebe orientacao de quem ja construiu negocios de sucesso. Dinheiro + mentoria e a combinacao que nao falha.' },
    { icon: <BarChart3 className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Ideias Simples Sao Valiosas', desc: 'Esqueça que so startup de tecnologia recebe investimento. Restaurante, loja, clinica, salao — negocios tradicionais recebem tanto ou mais que startups. Simples escala mais rapido.' },
    { icon: <Lock className="w-5 h-5 sm:w-6 sm:h-6" />, title: 'Vagas Limitadas', desc: 'Para manter a proporcao investidor/empreendedor e garantir que todo mundo receba lances, cada turma tem vagas limitadas. Quando fecha, so na proxima. E nao sabemos quando.' },
  ];
  return (
    <section ref={ref} className="bg-dark-gradient py-16 sm:py-20 relative overflow-hidden">
      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-10 sm:mb-16">
          <span className="inline-block bg-red-500/10 text-red-400 text-xs sm:text-sm font-semibold px-3 sm:px-4 py-1.5 rounded-full mb-4">Nao Deixe Pra Depois</span>
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-3 sm:mb-4">
            Por Que Voce Precisa <span className="text-amber-400">Agir Agora</span>
          </h2>
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto px-2">Cada dia que voce espera e um dia que alguem com uma ideia parecida com a sua ta la dentro recebendo o investimento que poderia ser seu</p>
        </div>
          ...
          <div className="glass rounded-2xl p-5 sm:p-6 max-w-2xl mx-auto border-l-4 border-red-400/60">
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                <p className="text-white font-bold text-sm sm:text-base mb-1">O custo de nao agir</p>
                <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
                  Voce vai continuar assistindo o Shark Tank pensando "eu podia ter feito isso"? Daqui a 1 ano, vai olhar pra tras e se perguntar: <span className="text-amber-400 font-semibold">"E se eu tivesse entrado naquele dia?"</span> O unico risco real e o de ficar de fora.
                </p>
              </div>
            </div>
          </div>
...
function Faq() {
  ...
  const { ref, isVisible } = useInView();
  const faqs = [
    { q: 'Eu realmente posso receber ate R$100.000?', a: 'Sim. Investidores na plataforma ja investiram de R$10.000 a R$500.000. O valor medio e R$75.000. R$100.000 e completamente realista — e acontece toda semana. Voce pode conferir os depoimentos acima.' },
    { q: 'Eu preciso ter experiencia empreendedora?', a: 'De jeito nenhum. Investidores-anjo investem na PESSOA tanto quanto na ideia. Vontade, paixao e disposicao valem mais do que curriculum. Muitos dos empreendedores que receberam investimento nunca tinham aberto um negocio antes.' },
    { q: 'Que tipo de negocio pode ser financiado?', a: 'Qualquer um. Restaurante, app, loja online, clinica, e-commerce, servico, SaaS, produto artesanal, franquia. Investidores buscam diversidade e potencial de retorno — nao so startup de tecnologia. Ideia simples com boa execucao vale tanto quanto ideia complexa.' },
    { q: 'Como funciona o processo de investimento?', a: 'Voce apresenta seu projeto. Investidores interessados fazem lances. Voce escolhe o melhor. Todo o processo juridico e de transferencia e conduzido com seguranca total e transparencia completa. Voce acompanha cada etapa.' },
    { q: 'E se eu nao receber nenhum lance?', a: 'Com 3x mais investidores que empreendedores na plataforma, a chance de nao receber lances e minima. Mas se acontecer, voce pode re-apresentar seu projeto. Nosso time te ajuda a otimizar tudo. E com a garantia de 7 dias, voce nao tem nada a perder.' },
    { q: 'Por que cobrar R$97 pra acessar?', a: 'Pense assim: R$97 e menos do que voce gasta num jantar. E o investimento que filtra quem e serio, mantem a qualidade da plataforma e garante suporte completo. O retorno potencial? Ate R$100.000 em financiamento. E 773x de retorno. Alem disso, se nao gostar, devolvemos os R$97 em 7 dias.' },
    { q: 'Isso e seguro? Como sei que nao e golpe?', a: 'Contratos formais, due diligence, acompanhamento juridico, investidores verificados com dados reais. Transparencia total em cada etapa. E a garantia incondicional de 7 dias — se nao confiar, pegue seu dinheiro de volta. Zero risco pra voce.' },
    { q: 'Quanto tempo leva pra receber o investimento?', a: 'Os primeiros lances chegam em 1-3 semanas em media. O processo completo leva 3-8 semanas. Mas voce ja comeca a ver interesse dos investidores nos primeiros dias.' },
  ];
  return (
    <section ref={ref} className="bg-section-dark py-16 sm:py-20">
      <div className={`max-w-3xl mx-auto px-4 sm:px-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-10 sm:mb-16">
          <span className="inline-block bg-teal-500/10 text-teal-400 text-xs sm:text-sm font-semibold px-3 sm:px-4 py-1.5 rounded-full mb-4">Transparencia Total</span>
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-black text-white mb-3 sm:mb-4">Perguntas Frequentes</h2>
          <p className="text-slate-400 text-sm sm:text-base max-w-xl mx-auto">Tire suas duvidas. Se ainda nao estiver 100% confiante, use a garantia de 7 dias sem risco.</p>
        </div>
      ...
      <div className={`max-w-4xl mx-auto px-4 sm:px-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="glass rounded-3xl p-6 sm:p-8 md:p-12 text-center relative overflow-hidden shine-effect">
          ...
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-black text-white mb-3 sm:mb-4">
            Garantia de <span className="text-teal-400">7 Dias</span> — Zero Risco Pra Voce
          </h2>
          <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-5 sm:mb-6">
            Se entrar na plataforma e por qualquer motivo achar que nao e pra voce, basta pedir o reembolso em ate 7 dias.
            <span className="text-white font-semibold"> Devolvemos cada centavo. Sem perguntas. Sem burocracia. Sem nenhuma dor de cabeca.</span>
          </p>
          <p className="text-slate-400 text-sm sm:text-base mb-5 sm:mb-6">
            Em outras palavras: <span className="text-amber-400 font-bold">ou voce recebe lances de investimento, ou recebe seu dinheiro de volta.</span> Nao tem como perder.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-slate-400 text-xs sm:text-sm">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2"><CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-teal-400" /> Em ate 48h</div>
      ...
      <div className={`max-w-5xl mx-auto px-4 sm:px-6 relative transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-3 sm:mb-4 leading-tight">
            Por R$97, Voce Pode Receber <span className="text-gradient-gold">Ate R$100.000</span>
          </h2>
        </div>
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-stretch">
          <div className="glass rounded-3xl p-6 sm:p-8 flex flex-col relative overflow-hidden shine-effect">
            ...
            <div className="mb-5 sm:mb-6">
              ...
              <p className="text-slate-400 text-xs sm:text-sm">Tudo que voce precisa pra receber investimento</p>
            </div>
            <div className="mb-5 sm:mb-6">
              ...
              <div className="flex items-baseline gap-1.5">
                ...
                <span className="text-slate-400 text-xs sm:text-sm">/acesso unico</span>
              </div>
              <p className="text-amber-400 text-xs sm:text-sm font-semibold mt-1.5">ou 12x de R$ 9,74 no cartao</p>
            </div>
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            <div className="glass rounded-2xl p-5 sm:p-6">
              <div className="flex items-center gap-2.5 sm:gap-3 mb-3 sm:mb-4">
                ...
                <h4 className="text-white font-bold text-base sm:text-lg">O Que Dizem os Numeros</h4>
              </div>
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="text-center bg-white/[0.03] rounded-lg p-3">
                  ...
                  <div className="text-slate-400 text-[10px] sm:text-xs">investimento medio</div>
                </div>
                <div className="text-center bg-white/[0.03] rounded-lg p-3">
                ...
                <div className="text-center bg-white/[0.03] rounded-lg p-3">
                  ...
                  <div className="text-slate-400 text-[10px] sm:text-xs">primeiro lance em media</div>
                </div>
              </div>
            </div>
            <div className="glass rounded-2xl p-5 sm:p-6 flex-grow">
              ...
              <p className="text-slate-300 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
                Voce investe <span className="text-amber-400 font-bold">R$97</span> pra acessar a plataforma.
                O retorno medio de investimento recebido e de <span className="text-teal-400 font-bold">R$75.000</span>.
              </p>
            ...
            <div className="glass rounded-2xl p-4 sm:p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-[10px] sm:text-xs leading-relaxed">Ambiente criptografado. Seus dados estao seguros. Garantia de 7 dias sem perguntas.</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="checkout" className="bg-dark-gradient py-16 sm:py-20 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-5 sm:mb-6 leading-tight">
          ...
          <br />
          <span className="text-gradient-hero">Voce So Precisa Do Acesso Certo</span>
        </h2>
        <p className="text-slate-300 text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-6 sm:mb-8 leading-relaxed px-2">
          Centenas de investidores estao agora na plataforma, buscando o proximo projeto.
          <span className="text-amber-400 font-semibold"> O proximo pode ser o seu.</span>
        </p>
